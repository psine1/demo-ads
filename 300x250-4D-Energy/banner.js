...
function fr1(){
  var tl_ = gsap.timeline();
    ...
    //.to("#svgRay, #lighten", {duration: 0.35, autoAlpha: 0}, ">")
	  ...
	  .from('#packages, #hexagons', 0.75, {y: 500, ease: "power3.out"}, "<")
    .from('#hexagons img', 2, {autoAlpha: 0.35, repeat: 1, yoyo: true, ease: "rough({ template:none.out, strength: 1, points:20, taper:none, randomize:true, clamp:false })"}, "<+0.5")

	  .fromTo('#btn', 1, {opacity: 0}, {opacity: 1, ease: "power3.out"}, "<+0.5")

	  .to('[id*="txt-2-"]', 0.65, {autoAlpha: 0, y: 0, ease: "power3.out"}, "<+2.2")
	  .to('#packages, #hexagons', 1.25, {y: 500, ease: "power3.out"}, "<")
    ...
    .to('#clinic2, #clinic1', 1, {x: -300, ease: "power3.out"}, "<+1.5")    
	  .to('[id*="txt-3-"]', 0.65, {autoAlpha: 0, y: 0, ease: "power3.out"}, "<")



    .from('[id*="txt-4-"]', 0.65, {autoAlpha: 0, y: 20, stagger: 0.15, ease: "power3.out"}, "<+0.5")
    .from('[id*="numbers"]', 0.65, {autoAlpha: 0, scale: 1.15, ease: "power3.out"}, "<+0.25")

    .to('[id*="txt-4-"]', 0.65, {autoAlpha: 0, ease: "power3.out"}, "<+2")
    ...
    .from('[id*="txt-5-"]', 0.65, {autoAlpha: 0, y: 20, stagger: 0.15, ease: "power3.out"}, "<+0.5")
	  .from('#img5', 1.25, {scale: 1.25, rotation: 0.05, transformOrigin: "50% 50%", ease: "power3.out"}, "<")
	  .from('#img5', 0.35, {autoAlpha: 0, transformOrigin: "50% 50%", ease: "power3.out"}, "<")

    .to('[id*="txt-5-"]', 0.65, {autoAlpha: 0, ease: "power3.out"}, "<+2")
    .to('[id*="img5"]', 0.65, {autoAlpha: 0, scale: 1.25, ease: "power3.out"}, "<")      

    .from('[id*="txt-6-"]', 0.65, {autoAlpha: 0, y: 20, stagger: 0.15, ease: "power3.out"}, "<+0.5")
	  .from('#endFrame', 1.25, {scale: 1.25, rotation: 0.05, transformOrigin: "50% 50%", ease: "power3.out"}, "<")
  ...
  gsap.set( "#th1, #th2, #th3", {autoAlpha: 1 } )
    let tl_thunder = gsap.timeline({ repeat: 5 });
        tl_thunder 
          ...
          .from(".ray1", {duration:0.65, drawSVG: 0}, "<")    
          .to("#th1", {duration:0.75, autoAlpha: 0, repeat: 1, ease: "power2.out"}, "<") 

          .from(".ray2", {duration:0.65, drawSVG: 0}, ">")    
          .to("#th2", {duration:0.75, autoAlpha: 0, repeat: 1, ease: "power2.out"}, "<") 
          
          .from(".ray3", {duration:0.65, drawSVG: 0}, ">")    
          .to("#th3", {duration:0.75, autoAlpha: 0, repeat: 1, ease: "power2.out"}, "<") 
