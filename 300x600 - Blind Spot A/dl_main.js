...
function pauseAllAnimations() {
  ...
  const tl_All = gsap.timeline({  });
      ...
      .to("[id*='car1']", { duration: 3, x: 50, y: -5, ease: "power2.inOut"  }, "<")
      ...
      .to(".wrapAd", { duration: 5, scale: 1.5, transformOrigin: "200px 382px", ease: "power3.out"  }, "<+1.2")
      ...
      .fromTo("#bg", {scale: 1}, { duration: 10, scale: 3, transformOrigin: "66px 382px", ease: "power3.out"  }, "<")
      .to("#wrapCar2", { duration: 0.01, x: 0, y: 0, ease: "power2.inOut"  }, "<")
      .to("[id*='car1']", { duration: 1.5, x: 0, y: 0, ease: "power2.out"  }, "<")
      .from("[id*='car1-lightL']", { duration: 0.35, autoAlpha: 0, repeat: 3, yoyo: true, ease: "none"  }, "<")

      .to(".wrapAd", { duration: 1, scale: 1, y: 0, transformOrigin: "200px 382px", ease: "power3.out"  }, "<+0.2")
