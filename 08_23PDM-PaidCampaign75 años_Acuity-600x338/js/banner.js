var banner = document.getElementById('wrapper'),
	...
	allAnimation = function () {
		...
		tl_
			...
			.to('.border-left', 1.5, {scaleY: 1, ease: Power4.easeOut}, 0.5)
			.from('.border-right', 2, {x: 150, ease: Power4.easeOut}, 0.5)
			.to('.border-bottom', 1.5, {scaleX: 1, transformOrigin: "100% 0%", ease: Power4.easeOut}, 0.5)
			...
			.from("#wrap-car", 2, {x: -400, ease:Power3.easeOut}, 1.5)
			...
			.fromTo('#txt-1-c', 1, {opacity: 0, y: 20, ease: Expo.easeOut}, {opacity: 1, y: 0, ease: Expo.easeOut}, 3.4)			
