...
gsap.registerPlugin(SplitText)
  ...
  var tl_number = gsap.timeline({delay: 2});
      tl_number.timeScale(1);  
      tl_number
      .fromTo("#contact", 0.65, {x: 100, y: 10, autoAlpha: 0}, {x: 0, y: 10, autoAlpha: 1, ease: "power3.out"}, "<")
      .from("#phone", 0.65, {x: 100, autoAlpha: 0, ease: "power3.out"}, "<+0.2")
      .to("#contact", 0.65, {y: 0, autoAlpha: 1, ease: "power3.out"}, "<+1")
      .from("#number", 0.65, {y: -10, autoAlpha: 0, ease: "power3.out"}, "<+0.15")
