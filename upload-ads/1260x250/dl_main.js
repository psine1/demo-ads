...
.from("#bg, #prod, .light-mask", 15, {scale: 1.2, ease: "power3.out"}, 0)
...
.from("#ft-1-glob", 0.5, {scale: 0.6, autoAlpha: 0, rotation: 30, transformOrigin: "50% 50%", ease: "power3.out"}, "<+0.5")

.from("#ft-2-1", 0.5, {x: 20, autoAlpha: 0, ease: "power3.out"}, "<+0.2")
.from("#ft-1-sign", 0.5, {scale: 0.35, rotation: 360, autoAlpha: 0, transformOrigin: "50% 45%", ease: "power3.out"}, "<+0.2")
.from("#ft-2-2", 0.5, {x: 20, autoAlpha: 0, ease: "power3.out"}, "<")

.from("#ft-3-1", 0.5, {y: -10, autoAlpha: 0, ease: "power3.out"}, "<+0.2")

    .fromTo(".light", { x: 0 }, { x: 1800, duration: 6, ease: "power3.out" }, "<") 
