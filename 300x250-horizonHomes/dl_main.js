...
function fr1(){
  ...
  var tl_ = gsap.timeline();
      tl_.timeScale(1);  
      tl_
      .from("#bg1", 7, {scale: 1.35, ease: "power3.out"}, "<")
      .from("#right-skyBlue", 2, {scale: 4.5, x: -250, ease: "power3.out"}, "<")
      ...
      .to("#right-skyBlue", 1, {scale: 4.5, x: -280, ease: "power3.out"}, "<+2.5")
