...
function fr1(){
  var tl_ = gsap.timeline();
      ...
      .from('#footer1', 0.5, { y: 20, ease: "power3.out" }, "<")

      .from('#img1', 5, { scale: 1.15, ease: "power3.out" }, "<")    

      .from('#footer2', 0.5, { y: 20, ease: "power3.out" }, "<+0.05")
      ...
      .to('#radar, #containerInsects', 0.01, { x: 10, y: -50, ease: "power3.out" }, "<")
      ...
      .to('#radar', 0.75, { scale: 1, autoAlpha: 1, ease: "power3.out" }, "<-0.5")
      .to('#radar, #containerInsects', 0.01, { x: -30, y: 30, ease: "power3.out" }, "<")
