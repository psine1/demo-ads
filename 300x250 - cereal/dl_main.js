...
function fr1(){
  var tl_ = gsap.timeline();
      ...
      .from('#bg2', 0.5, { autoAlpha: 0, ease: "power3.out" }, "<")
      ...
      .from('#bg3', 0.5, { autoAlpha: 0, ease: "power3.out" }, "<")
      .to('#starbust', 0.35, { autoAlpha: 0.43, ease: "none" }, "<")
      ...
      .add( function () {endframe = 3} , "<")
      .add( function (){ flairs(3) }, "<+0.1" )
...
function flairs(flairIndex = 1) {
  ...
  // explosion
   let tl2 = gsap.timeline()
    ...
    .to(bullets, { duration: tl1Time, physics2D: { velocity: "random(600, 450)", angle: () => 270 + gsap.getProperty(cannon, "rotation"),  gravity: 600  }, rotation: "random(0, 360)", stagger: { each: 0.02 } }, 0);
